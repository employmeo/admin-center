...
adminPortal.prototype.init = function() {
...
adminPortal.prototype.login = function () {
...
adminPortal.prototype.loginSuccess = function(data) {
...
/*	
	...
	//if (!this.urlParams.component) 
		this.urlParams.component = 'blank';
...
adminPortal.prototype.loginFail = function(data) {
	$("#wait").addClass('hidden');
	$('#loginresponse').text(data.responseText);
	$('#login').removeClass('hidden');
}

adminPortal.prototype.requestPasswordChange = function() {
...
adminPortal.prototype.signup = function() {
...
adminPortal.prototype.logout = function () {
	$("#wait").removeClass('hidden');			
	postLogout();
}


adminPortal.prototype.updateLocationSelect = function (detail) {
...
adminPortal.prototype.updateAssessmentSelect = function (detail) {
...
adminPortal.prototype.updatePositionSelect = function (detail) {
...
adminPortal.prototype.initializeDatePicker = function (callback) {
...
adminPortal.prototype.initDashBoard = function() {
...
adminPortal.prototype.requestDashUpdate = function() {
...
adminPortal.prototype.updateDash = function(data) {	
...
adminPortal.prototype.refreshDashApplicants = function(data) {
...
adminPortal.prototype.refreshDashHires = function(data) {
...
adminPortal.prototype.addHireRateBar = function(data) {
...
adminPortal.prototype.updateLastTen = function(data) {
...
adminPortal.prototype.initGradersTable = function(){
	var thePortal = this;
...
adminPortal.prototype.searchGraders = function() {
	this.graderParams ={};
...
adminPortal.prototype.renderAudioLink = function(row, link) {
	var audio = $('<audio />' , {
		'controls': '',
...
adminPortal.prototype.togglePlayMedia = function(id) {
...
adminPortal.prototype.updateGradersTable = function(data) {
	this.myGraders = data;		
...
adminPortal.prototype.showGradesPanel = function() {
...
adminPortal.prototype.createGradeForm = function (criterion) {
...
adminPortal.prototype.submitGrade = function(graderId, questionId) {
	var thePortal = this;
...
adminPortal.prototype.logSavedGrade = function(grade) {
...
adminPortal.prototype.ignoreGrader = function(graderId) {
...
adminPortal.prototype.checkGraderStatus = function(updatedGrader) {
...
adminPortal.prototype.getAssessmentBy = function(asid) {
...
adminPortal.prototype.getPositionBy = function(id) {
...
adminPortal.prototype.getLocationBy = function(id) {
...
adminPortal.prototype.getCorefactorBy = function(id) {
...
adminPortal.prototype.getProfile = function(series) {
...
adminPortal.prototype.renderRespondantActions = function(respondant) {
	var cell = $('<td />');
	var thePortal = this;
...
adminPortal.prototype.searchRespondants = function() {
	var thePortal = this;
	var fields = $('#refinequery').serializeArray();
	this.respParams = {};
...
adminPortal.prototype.updateRespondantsTable = function() {	
	var thePortal = this;
...
adminPortal.prototype.initSurveyQuestionsTable = function() {
...
adminPortal.prototype.updateSurveyQuestions = function() {
...
adminPortal.prototype.updateHistory = function(historyData) {
...
adminPortal.prototype.presentPredictions = function() {
...
adminPortal.prototype.addPrediction = function(prediction) {
	var card = $('<div />', { 'class' : 'col-md-4 col-sm-4 col-xs-12 text-center'});
...
adminPortal.prototype.produceHistogram = function(prediction) {
...
adminPortal.prototype.changePositionTo = function(id) {	
...
adminPortal.prototype.showAllDetails = function() {
...
adminPortal.prototype.hideAllDetails = function() {
	for (i in this.respondant.respondantScores) {
		var score = this.respondant.respondantScores[i];
...
adminPortal.prototype.showDetail = function(cfid) {
...
adminPortal.prototype.hideDetail = function(cfid) {
...
adminPortal.prototype.inviteApplicant = function () {	
	this.invitation = {};
...
adminPortal.prototype.prepPersonalMessage = function(score) {
...
adminPortal.prototype.renderAssessmentScore = function(detail) {
...
adminPortal.prototype.getBarClass = function(quartile) {
	var barclass;
	switch (quartile) {
	case 0:
...
adminPortal.prototype.initRespondantGraderTables = function() {
	var thePortal = this;
...
adminPortal.prototype.updateRespondantGraderTables = function() {
	var thePortal = this;
...
adminPortal.prototype.renderEvaluationsDetail = function(data) {
...
adminPortal.prototype.updateGradesTable = function(grades) {
	$('#gradetable').empty();
	$('#gradefooter').empty();
...
adminPortal.prototype.getProfileBadge = function(profile) {
	var div = $('<div />', {
		'class':'profilesquare',
		'data-toggle' : 'tooltip',
...
adminPortal.prototype.initCriticalFactorsChart = function() {
...
adminPortal.prototype.updateCriticalFactorsChart = function() {
...
adminPortal.prototype.uploadPayroll = function(e) {
	$('#csvFile').parse({
		config : {
			header: true,
			dynamicTyping: true,
...
adminPortal.prototype.readyLeftNav = function() {
	var thePortal = this;
...
adminPortal.prototype.readyTopNav  =function() {
...
adminPortal.prototype.showComponent = function(component) {
...
adminPortal.prototype.activateUIElements = function() {
